...
#define kKit1ProductIdentifier @"com.Saltb0xApps.BeatsMaker.kit1" 

@implementation ATIAPKit1ViewController
...
- (void)viewDidLoad {
    ...
    FAQLabel.text = @"This In-App purchase will unlock Drum kit 1 which contains blues, cadence, choral, classic & conjunto drums";
    ...
    [PurchaseButton setTitle:@"Unlock Drum Kit 1 (1.99$)" forState:UIControlStateNormal];
...
- (void)PurchaseEx {
    ...
    self.productsRequest = [[SKProductsRequest alloc] initWithProductIdentifiers:[NSSet setWithObject:kKit1ProductIdentifier]];
    ...
    for(SKPaymentTransaction *transaction in transactions){
        switch (transaction.transactionState){
            ...
            case SKPaymentTransactionStatePurchased:
                ...
                [TransactionSuccessfulAlert showSuccess:self title:@"Transaction Successful" subTitle:@"You can now select blues, cadence, choral, classic & conjunto drums" closeButtonTitle:@"Okay" duration:0];
