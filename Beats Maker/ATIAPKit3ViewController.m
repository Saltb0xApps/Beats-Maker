...
#define kKit3ProductIdentifier @"com.Saltb0xApps.BeatsMaker.kit3"

@implementation ATIAPKit3ViewController
...
- (void)viewDidLoad {
    ...
    FAQLabel.text = @"This In-App purchase will unlock Drum kit 3 which contains pearl, phaser, rough, smooth & swing drums.";
    ...
    [PurchaseButton setTitle:@"Unlock Drum Kit 3 (1.99$)" forState:UIControlStateNormal];
...
- (void)PurchaseEx {
    ...
    self.productsRequest = [[SKProductsRequest alloc] initWithProductIdentifiers:[NSSet setWithObject:kKit3ProductIdentifier]];
    ...
    for(SKPaymentTransaction *transaction in transactions){
        switch (transaction.transactionState){
            ...
            case SKPaymentTransactionStatePurchased:
                ...
                [TransactionSuccessfulAlert showSuccess:self title:@"Transaction Successful" subTitle:@"You can now select pearl, phaser, rough, smooth & swing drums" closeButtonTitle:@"Okay" duration:0];
